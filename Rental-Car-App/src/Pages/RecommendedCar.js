...
const RecommendedCar = () => {
  return (
    <>
            ...
            <div className="mt-8 px-6 lg:px-16 lg:mt-16 flex justify-between items-center mb-5 lg:mb-[30px]">
        <p className="text-[#90A3BF] text-sm font-semibold">Recommendation Car</p></div>
    ...
    <div className="flex items-center lg:mt-16 lg:mb-16 lg:px-16">
